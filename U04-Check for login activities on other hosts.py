...
def add_comment_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    playbook_input_current_task_values = [item[0] for item in playbook_input_current_task]
    ...
    phantom.comment(container=container, comment=playbook_input_current_task_values)
